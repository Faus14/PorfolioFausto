    ...
    <div id="experience" className="relative z-50 border-t my-12 lg:my-24 border-[#25213b]">
      ...
      <div className="py-8">
        <div className="relative">
          ...
          {/* viewport sin paddings internos, con gap entre slides */}
          <div
            ref={viewportRef}
            tabIndex={0}
                  ...
                  <div className="relative p-0">
                    ...
                    <div className="flex items-start gap-x-4 px-4 py-3">
                      ...
                      <div className="w-full">
                        ...
                        {/* descripción sin panel/padding extra */}
                        ...
                        {exp.tools && exp.tools.length > 0 && (
                          <div className="mt-3">
                            <div className="flex items-center mb-1">
                              <BsTools className="text-[#16f2b3] mr-2" size={12} />
                            ...
                            <div className="flex flex-wrap gap-2">
                              {exp.tools.map((tool, i) => (
                                <span
                                  key={i}
                                  className="px-2 py-0.5 text-[11px] bg-gradient-to-r from-violet-600/20 to-pink-600/20 border border-violet-500/30 rounded-full text-violet-200 hover:from-violet-600/30 hover:to-pink-600/30 transition-all duration-200"
                                >
                                  {tool}
                                </span>
                              ))}
          ...
          {mounted && (
            <div className="mt-4 flex justify-center gap-2">
              {Array.from({ length: Math.max(1, Math.ceil(itemCount / itemsPerView)) }).map((_, p) => (
                <button
                  key={p}
