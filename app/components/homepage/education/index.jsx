  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-3 sm:px-6 lg:px-8">
        {/* Tabs responsivas - ✅ Optimizado para móvil */}
        ...
        <div className="relative">
          ...
          >
            {getCurrentEducations().map((education, index) => {
              ...
              return (
                <div key={education.id} className="relative pl-10 sm:pl-14 md:pl-20 group">
                  {/* Punto de la línea - ✅ Más pequeño en móvil */}
                  <div className="absolute left-1 sm:left-2.5 md:left-4 top-5 sm:top-7">
                    <div
                      className={`w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br transition-all duration-500 flex items-center justify-center shadow-lg ${
                        index === 0
                  ...
                  <div
                    className={`bg-gradient-to-br from-[#1a1443]/60 via-[#2a1f5f]/40 to-[#1a1443]/60 backdrop-blur-sm rounded-xl sm:rounded-2xl border transition-all duration-500 overflow-hidden ${
                      index === 0
                              ...
                              <div className="mt-2.5 sm:mt-3 md:mt-4">
                                ...
                                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                                  {education.skills.map((skill, i) => (
                                    <span
                                      key={i}
                                      className="px-2 sm:px-2.5 md:px-3 py-1 sm:py-1.5 text-[10px] sm:text-[11px] md:text-xs font-medium bg-gradient-to-r from-blue-600/20 to-violet-600/20 border border-blue-500/30 rounded-lg text-blue-200 hover:from-blue-500/30 hover:to-violet-500/30 hover:border-blue-400/50 transition-all duration-300"
                                    >
        ...
        {/* Stats: 2 bloques - ✅ Oculto en móvil, visible en tablet/desktop */}
